...
const HomePage = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:9090/ems-backend/api/admins")
      .then((res) => res.json())
  ...
  const handleLoginSubmit = async (e) => {
    ...
    if (credentials.role === "admin") {
      url = "http://localhost:9090/ems-backend/api/admins/login";
    } else if (credentials.role === "employee") {
      url = "http://localhost:9090/ems-backend/api/employees/login";
    } else if (credentials.role === "hr") {
      url = "http://localhost:9090/ems-backend/api/hr/login";
    }
  ...
  const handleSignupSubmit = async (e) => {
    ...
    if (signupData.role === "admin") {
      url = "http://localhost:9090/ems-backend/api/admins/create";
    } else if (signupData.role === "employee") {
      url = "http://localhost:9090/ems-backend/api/employees/create";
    } else if (signupData.role === "hr") {
      url = "http://localhost:9090/ems-backend/api/hr/create";
    }
