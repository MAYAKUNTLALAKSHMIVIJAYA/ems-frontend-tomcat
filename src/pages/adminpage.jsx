...
const AdminDashboard = () => {
  ...
  const fetchEmployees = async () => {
    const res = await fetch("http://localhost:9090/ems-backend/api/employees");
    const data = await res.json();
    setEmployees(data);
  };

  const fetchHrAccounts = async () => {
    const res = await fetch("http://localhost:9090/ems-backend/api/hr/accounts");
    const data = await res.json();
    setHrAccounts(data);
  };

  const fetchSignupRequests = async () => {
    const empRes = await fetch("http://localhost:9090/ems-backend/api/employees/pending");
    const empData = await empRes.json();

    const hrRes = await fetch("http://localhost:9090/ems-backend/api/hr/pending");
  ...
  const handleAddEmployee = async (e) => {
    e.preventDefault();
    const response = await fetch("http://localhost:9090/ems-backend/api/employees/create", {
      method: "POST",
    ...
    if (response.ok) {
      ...
      await fetch(`http://localhost:9090/ems-backend/api/employees/approve/${data.id}`, { method: "POST" });
      fetchEmployees();
      fetchSignupRequests();
  ...
  const handleAddHr = async (e) => {
    e.preventDefault();
    const response = await fetch("http://localhost:9090/ems-backend/api/hr/create", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    if (response.ok) {
      const data = await response.json();
      await fetch(`http://localhost:9090/ems-backend/api/hr/approve/${data.id}`, { method: "POST" });
      fetchHrAccounts();
      fetchSignupRequests();
      setShowAddHr(false);
      setNewHr({
  ...
  const handleUpdateEmployee = async (e) => {
    e.preventDefault();
    await fetch(`http://localhost:9090/ems-backend/api/employees/${editEmployee.id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  const handleUpdateHr = async (e) => {
    e.preventDefault();
    await fetch(`http://localhost:9090/ems-backend/api/hr/${editHr.id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  const handleDeleteEmployee = async (id) => {
    await fetch(`http://localhost:9090/ems-backend/api/employees/${id}`, { method: "DELETE" });
    fetchEmployees();
  };

  // Delete HR
  const handleDeleteHr = async (id) => {
    await fetch(`http://localhost:9090/ems-backend/api/hr/${id}`, { method: "DELETE" });
    fetchHrAccounts();
  };
  ...
  const handleApproveRequest = async (request) => {
    ...
    if (request.role === "employee") {
      url = `http://localhost:9090/ems-backend/api/employees/approve/${request.id}`;
    } else {
      url = `http://localhost:9090/ems-backend/api/hr/approve/${request.id}`;
    }
  ...
  const handleRejectRequest = async (request) => {
    let url = "";
    if (request.role === "employee") {
      url = `http://localhost:9090/ems-backend/api/employees/reject/${request.id}`;
    } else {
      url = `http://localhost:9090/ems-backend/api/hr/reject/${request.id}`;
    }
